      ...
      <div class="flex h-screen flex-col justify-between pt-2 pb-6">
        ...
        <div>
            ...
            <ul class="mt-1 space-y-2 tracking-wide">
                <a href="#" aria-label="commandCenter" class="relative flex items-center space-x-4 px-4 py-3 text-blue-800">
                    <img src="../img/cc.svg" class="h-14 w-14" alt="">
                  <span class="-mr-1 font-medium">COMMAND CENTER</span>
                </a>
            </ul>
